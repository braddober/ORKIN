...
# USER DEFS:
#################################################
rootdir0='/data/raw/' # default
freqFile0='/data/raw/default_freqs.txt' #default
loSpanShort=1e6 #1
loSpanLong=2e6  #2
#maxv=5 # specify maximum bias voltage, with 2kohm resistor
maxv=0.4 # without 2kohm resistor
extraPlots=0
...
um=umuxlib.util(rootdir=rootdir)
#um=umuxlib_old_bof18d.util(rootdir=rootdir)
